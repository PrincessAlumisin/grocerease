            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <p>Secure your account with a stronger password. </p>
                        <?php echo $msg; ?>
                        <form action="" method="post">
                            <input type="password" class="password" name="password" placeholder="Enter New Password" required>
                            <input type="password" class="confirm-password" name="confirm-password" placeholder="Enter New Confirm Password" required>
